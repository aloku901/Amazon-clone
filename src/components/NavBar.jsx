    ...
    <header className='min-w-[1000px] '>
        <div className='flex bg-amazonclone text-white h-[60px]'>
            <div className='flex items-center m-4'>
                <Link to={"/"}>
                    <img className='h-[35px] w-[100%] m-2' src={"../images/amazon.png"}/>
                </Link>
                <div className='pr-4 pl-4'>
                    <div className='text-xs xl:text-sm p-0 '>Deliver to</div>
            ...
            <div className='flex items-center m-4'>
                <div className='pr-4 pl-4'>
                    <div className='text-xs xl:text-sm p-0 '>Hello, sign in</div>
                    <div className='text-sm xl:text-base font-bold'>Accounts & Lists</div>
                </div>
                <div className='pr-4 pl-4'>
                    <div className='text-xs xl:text-sm p-0 '>Returns</div>
